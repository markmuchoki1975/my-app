package com.example.application.views.admintasks;


import com.example.application.views.MainLayout;
import com.example.application.views.admintasks.ServiceHealth.Status;
...
public class AdminTasksView extends Main {

    public AdminTasksView() {
        addClassName("admin-tasks-view");
